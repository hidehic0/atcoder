...
def op(a, b):
    return (
        (a[0] + b[0] + a[1] * b[3]) % 998244353,
        a[1] + b[1],
        a[2] + b[2],
        (a[3] + a[1] * b[2] + b[3] + a[4] * b[3]) % 998244353,
        b[4],
    )


def mapping(l, r):
    t = (r[3] + simple_sigma(r[2] - 1) * l) % 998244353
    return (
        (r[0] + t * l) % 998244353,
        (r[1] + r[2] * l) % 998244353,
        r[2],
...
seg = LazySegTree(
    op, (0, 0, 0, 0, 0), mapping, composition, 0, [(0, 0, 1, 0, 0) for _ in [0] * N]
)
