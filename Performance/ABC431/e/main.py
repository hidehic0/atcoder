...
def getd(l):
    return [(a, b, MOVES1.index((a, b))) for a, b in l]


MA = getd([(0, 1), (0, -1), (-1, 0), (1, 0)])
MB = getd([(1, 0), (-1, 0), (0, -1), (0, 1)])
MC = getd([(-1, 0), (1, 0), (0, 1), (0, -1)])
    ...
    while Q:
        ...
        match S[x][y]:
            case "A":
                ...
                if coordinate_check(nx, ny, H, W) and used[nx][ny][nd] > used[x][y][d]:
                    used[nx][ny][nd] = used[x][y][d]
                ...
                for M in [MB, MC]:
                    ...
                    if nx == H - 1 and ny == W:
                        ans.set(used[x][y][d] + 1)

                    if (
                        coordinate_check(nx, ny, H, W)
                        and used[nx][ny][nd] > used[x][y][d] + 1
                    ):
                        used[nx][ny][nd] = used[x][y][d] + 1
                        Q.append((nx, ny, nd))
