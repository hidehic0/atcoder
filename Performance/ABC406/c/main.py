...
A = SegTree(op=lambda a, b: a + b, e=0, v=N)
B = SegTree(op=lambda a, b: a + b, e=0, v=N)
...
for i in range(N - 1):
    a = binary_search(lambda mid: A.prod(i + 1, mid + 1) < 1, N, i + 1) + 1
    b = binary_search(lambda mid: B.prod(i + 1, mid + 1) < 1, N, i + 1) + 1
