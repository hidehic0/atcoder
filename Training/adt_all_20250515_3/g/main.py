...
while Q:
    ...
    for nx, ny in grid_moves(x, y, H, W, MOVES[mode ^ 1], lambda x, y: S[x][y] != "#"):
        if used[nx][ny][mode ^ 1] != INF:
            continue

        used[nx][ny][mode ^ 1] = used[x][y][mode] + 1
        Q.append((nx, ny, mode ^ 1))
