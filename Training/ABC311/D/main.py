...
# コード
N, M = il()
L = [list(s()) for _ in [0] * N]

S = deque()
S.append((1, 1))
is_stoped = [[False] * M for _ in [0] * N]
is_stoped[1][1] = True
is_used = [[False] * M for _ in [0] * N]
is_used[1][1] = True
    ...
    for i in range(4):
        ...
        while True:
            ...
            if L[crr_h][crr_w] == "#":
                ...
                is_used[crr_h][crr_w] = True

        if not is_stoped[crr_h][crr_w]:
            is_stoped[crr_h][crr_w] = True
            S.append((crr_h, crr_w))
