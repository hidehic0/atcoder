...
def solve(k, L, cntL):
    ...
    return res + max(r - l - k, 0) * min(rcnt, lcnt)


def check(k):
    return solve(k, A, cntX) + solve(k, B, cntY) > K


print(binary_search(check, 10**17) + 1)
